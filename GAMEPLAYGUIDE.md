...
In addition new content, Nordic Souls changes the starting requirements for quite a few quests as well. As the list is a bit extensive, I've put the changes in a document [here](https://github.com/SkrubbySkrubInAShrub/nordic-souls-PBR/blob/main/QUESTCHANGES.md). If you can't start a quest, it is likely because you haven't met the correct conditions, and you should check that document.
...
- [Vigilant](https://www.nexusmods.com/skyrimspecialedition/mods/11849) is a questline for the Vigilants of Stendarr. It has a very dark and grim atmosphere, heavily inspired by Dark Souls. It includes a lot of unique armor sets, weapons, jewelry, creatures, and more. Check [this document](https://github.com/SkrubbySkrubInAShrub/nordic-souls-PBR/blob/main/QUESTCHANGES.md) for the updated starting conditions.
- [Unslaad](https://www.nexusmods.com/skyrimspecialedition/mods/11789) is a quest mod about a half-dragon, and includes fluffy equipment and creatures. Unlike Vigilant, it has a colder and sadder undertone, but also a bit of hope. Check [this document](https://github.com/SkrubbySkrubInAShrub/nordic-souls-PBR/blob/main/QUESTCHANGES.md) for the updated starting conditions. Recommended as the finale for your character.
